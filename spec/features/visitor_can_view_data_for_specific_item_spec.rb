...
RSpec.feature "visitor can view data for specific items", type: :feature do
  context 'as a visitor when I visit the show page' do
    let!(:item) {Item.create(title: "Brachiosaurus Scarf",
                description: "An extra long scarf for all of those
                littlefoots in your life", price: 230, image:
                "img[src*='http://vignette1.wikia.nocookie.net/scarfheroes/images/e/e6/Royal-stewart-tartan-lambswool-scarf.jpg/revision/latest?cb=20150322230625']")}
